...
import { _find, _findMany, _findHasMany, _findBelongsTo, _findAll, _query as _query3, _queryRecord } from "./store/finders";
...
Store = Ember.Service.extend({
  ...
  */
  ...
  _query: function _query(modelName, query, array) {
    ...
    var pA = promiseArray(_query3(adapter, this, modelName, query, array));
